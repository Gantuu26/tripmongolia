                ...
                <div className="flex-1 flex flex-col px-6 pt-4 pb-32">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-[16px] font-normal leading-relaxed">
                            담당자가 확인 후 24시간 이내에<br />맞춤 견적을 보내드립니다.
                        </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-[#1a2c28] rounded-3xl p-6 shadow-sm mb-8">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-sm font-bold text-gray-900 dark:text-white">요청 내용 요약</h3>
                        </div>
                    ...
                    <div className="w-full mb-12">
                        <div className="flex justify-between items-end mb-3 px-1">
                            <h3 className="text-lg font-bold text-[#121716] dark:text-white">기다리는 동안 둘러보기</h3>
                            <button onClick={() => navigate('/products')} className="text-xs text-gray-400 font-medium cursor-pointer">더 보기</button>
                        </div>

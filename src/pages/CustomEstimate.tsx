...
const CustomEstimateMobile: React.FC = () => {
    ...
    const [selectedThemes, setSelectedThemes] = useState<string[]>(['힐링/휴양', '호캉스']);
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-white antialiased selection:bg-primary selection:text-white pb-28">
            <SEO 
                title={t('estimate.seo_title', '맞춤 견적 요청 | Trip Mongolia')}
                description={t('estimate.seo_description', '몽골 여행에 대한 맞춤 견적을 요청해보세요. Trip Mongolia이 여러분의 조건에 딱 맞는 여행 일정을 제안해 드립니다.')}
            />
            <div className="sticky top-0 z-50 flex items-center justify-between bg-white dark:bg-zinc-900 p-4 border-b border-gray-100 dark:border-zinc-800">
                ...
                <h2 className="text-lg font-bold leading-tight tracking-tight flex-1 text-center pr-10 text-[#0e1a18] dark:text-white">몽골 맞춤 견적</h2>
            </div>
            ...
            <div className="max-w-md mx-auto w-full flex flex-col gap-2">
                ...
                <div className="px-4 pt-4">
                    <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden relative">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <h3 className="text-sm font-bold text-slate-800 dark:text-white">실시간 견적 현황</h3>
                        </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-[#1eb496] font-medium">견적 작성 중...</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-[#1eb496] font-medium">담당자 배정 중</span>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[10px] text-[#1eb496] font-medium">견적 접수</span>
                                        </div>
                                    </div>
                ...
                <div className="flex flex-col bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    <h3 className="text-lg font-bold mb-3 px-1 text-slate-900 dark:text-white">희망 투어 목적지 <span className="text-sm font-normal text-slate-400 ml-1">(복수 선택 가능)</span></h3>
                ...
                <div className="flex flex-col bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                            <label className="text-xs font-bold text-slate-500 mb-1.5 block ml-1">몽골 출국일</label>
                            <div className="relative">
                                <input
                                    type="date"
                                    value={endDate}
                ...
                <div className="bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    ...
                    <div className="flex flex-wrap gap-2.5">
                        {[
                            { emoji: '💆‍♀️', label: '힐링/휴양', checked: true },
                            { emoji: '🏄‍♂️', label: '액티비티', checked: false },
                            { emoji: '🍽️', label: '맛집 탐방', checked: false },
                ...
                {/* Accommodation */}
                <div className="bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    <h3 className="text-lg font-bold mb-3 px-1 text-slate-900 dark:text-white">숙박 옵션</h3>
                    <div className="flex flex-wrap gap-2.5">
                        {[
                ...
                <div className="bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    ...
                    <div className="flex flex-wrap gap-2.5">
                        {[
                            ...
                            { icon: 'airport_shuttle', label: '하이에이스', checked: false },
                            { icon: 'directions_bus', label: '소형 버스', checked: false },
                            { icon: 'directions_bus', label: '대형 버스', checked: false },
                        ].map((item, idx) => (
                            <label key={idx} className="cursor-pointer group">
                                <input
                                    type="radio"
                ...
                <div className="bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-lg font-bold px-1 text-slate-900 dark:text-white">여행 예산</h3>
                        <span className="text-xs text-primary font-bold bg-primary/10 px-2 py-1 rounded-md">1인당 예산</span>
                    </div>
                ...
                {/* Additional Request */}
                <div className="bg-white dark:bg-zinc-900 px-4 py-6 mt-2 shadow-sm dark:border-t dark:border-b dark:border-zinc-800">
                    <h3 className="text-lg font-bold mb-4 px-1 text-slate-900 dark:text-white">기타 요청 사항</h3>
                    <div className="relative">
                        <textarea
                            ...
                            placeholder="특별히 원하시는 사항이 있으시면 자유롭게 기재해 주세요.">
                        </textarea>
                    </div>
                </div>

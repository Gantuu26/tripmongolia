            ...
            <div className="px-5 min-h-[400px]">
                ...
                <div className="relative w-full aspect-[21/9] rounded-2xl overflow-hidden mb-6 shadow-sm bg-slate-900 group">
                    ...
                    <img
                        ...
                        alt={`${currentTabInfo.title}｜${currentTabInfo.name} 몽골여행`}
                        width={800}
                        height={340}
                        fetchPriority="high"
                    ...
                    <div className="absolute bottom-0 left-0 p-6 w-full pointer-events-none z-20">
                        ...
                        <h3 className="text-[14px] sm:text-[16px] md:text-xl lg:text-3xl font-bold text-white mb-0.5 md:mb-2 text-left truncate w-full">
                            {currentTabInfo.title}
                        </h3>
                        <p className="text-white/80 text-[9px] sm:text-[11px] md:text-sm font-medium text-left truncate w-full">
